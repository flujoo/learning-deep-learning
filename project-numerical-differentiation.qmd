# Project: Numerical Differentiation
...
The code is in [code/project_numerical_differentiation.py](https://github.com/flujoo/learning-deep-learning/blob/master/code/project_numerical_differentiation.py).
